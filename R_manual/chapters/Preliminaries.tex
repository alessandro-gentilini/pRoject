...
common features of some \samp{R} packages
...
moreover, given any \samp{R} function, the 
line \samp{?<function>} prompts the corresponding
...
by \samp{R}, in particular we will mainly refer to
\samp{data(iris)}, \samp{data(mtcars)} and \samp{data(morley)}. 
We will henceforth refer to a generic data frame as to \samp{df}.
