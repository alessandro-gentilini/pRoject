%************************************************
\section{Data clustering}\label{sec: clusters}
%************************************************
...
\end{example}
The function \samp{hclust} pairwise couples the points
...
\samp{install.packages("ggdendro")}\\
\samp{library("ggdendro")}
\bigskip 
...
\begin{figure}[htbp]
 \centering
 \includegraphics[scale=0.2]{images/dendo}
...
\samp{kmeans} needs a set of data whose 
